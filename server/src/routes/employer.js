...
router.post('/company', [
  body('name').notEmpty(),
  body('tax_code').notEmpty(),
  body('address').notEmpty(),
], validate, compCtrl.createCompany);
...
], validate, jobCtrl.createEmployerJob);
...
router.put('/applications/:id/status', [
  body('status').isIn(['VIEWED', 'INTERVIEW', 'HIRED', 'REJECTED']),
], validate, appCtrl.updateApplicationStatus);
